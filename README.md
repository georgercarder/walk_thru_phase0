...
In this exploration we will focus on the current phase, Phase 0. Our goal is to learn about each node in this upgrade. We'll do this by building and running the respective software, describing its role in the ultimate roll-out (Phase 2) and its role in this phase (Phase 0), and actually tracing its interactions within the system.
